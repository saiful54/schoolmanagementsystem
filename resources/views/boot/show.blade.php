...
<div class="row">
    <div class="col-md-9 col-md-offset-2" style="margin-left: 20.666667%;
    margin-top: 1%;">
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tr>
                ...
                <td>{{ $print->email }}</td>
                <td>{{ $print->phone }}</td>
                <td><a href="{{ route('addform.edit', $print->id) }}" class="btn btn-info btn-sm" style="float:left; padding: 2px 7px; margin-right:5px">Edit</a>
